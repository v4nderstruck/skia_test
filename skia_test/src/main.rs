...
fn main() {
    ...
    // load image
    let mut gif = gif_renderer::GifTextureRenderer::load_gif("media/media.gif").unwrap();
    ...
    el.run(move |event, _, control_flow| {
        ...
        if draw_frame {
            ...
            // icon_renderer::render_frame(frame % 360, 60, 60, canvas);
            frame = gif.render_frame(frame, canvas);
